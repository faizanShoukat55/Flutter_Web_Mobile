...
import 'login_tab2_view_model.dart';


class LoginTab2Page extends StatelessWidget {
  const LoginTab2Page({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (context) => LoginTab2PageViewModel(),
        child: Consumer<LoginTab2PageViewModel>(
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: CustomSVGImage(
                          width: 220.w,
                          height: 145.h,
                          path: ImagesPath.loginAboutMeImage),
                    ),
                  ),
                ],
              ),
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: CustomSVGImage(
                          width: 220.w,
                          height: 145.h,
                          path: ImagesPath.loginSwipeProfilesImage),
                    ),
                  ),
                ],
              ),
