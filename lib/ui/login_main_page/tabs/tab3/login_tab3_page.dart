...
import 'login_tab3_view_model.dart';


class LoginTab3Page extends StatelessWidget {
  const LoginTab3Page({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (context) => LoginTab3PageViewModel(),
        child: Consumer<LoginTab3PageViewModel>(
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: CustomSVGImage(
                          width: 220.w,
                          height: 145.h,
                          path: ImagesPath.loginBusinessDealImage),
                    ),
                  ),
                ],
              ),
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: CustomSVGImage(
                          width: 220.w,
                          height: 145.h,
                          path: ImagesPath.loginJobOffersImage),
                    ),
                  ),
                ],
              ),
